...
namespace Phonebook.Data.Migrations
{
	internal sealed class Configuration : DbMigrationsConfiguration<Context.PhonebookContext>
	{
		...
		protected override void Seed(Context.PhonebookContext context)
		{
			var users = new List<User>
			{
				new User { Id = new Guid("7b8ceac1-9fb1-4e15-af4b-890b1f0c3ebf"), Username = "User123" },
				new User { Id = new Guid("5875412f-e8b8-493e-bd58-5df35083342c"), Username = "User456" },
				new User { Id = new Guid("26e31dde-4bcb-47d4-be80-958676c5cafd"), Username = "User789" },
				new User { Id = new Guid("cef70a7a-3349-4368-85ed-66b8c274fad1"), Username = "mjenkins0" },
				new User { Id = new Guid("71d8e924-7c58-4424-9e1b-b14eefa76abc"), Username = "amartin1" },
				new User { Id = new Guid("a051d1ca-a3c5-45d4-be60-5bc5256ce83e"), Username = "vallen2" },
				new User { Id = new Guid("2b3b4d72-1c15-40e0-a05a-012b724950c3"), Username = "mblack3" },
				new User { Id = new Guid("2550f510-e5c9-45a4-90a0-c286e4bcd948"), Username = "schapman4" },
				new User { Id = new Guid("874c0bc3-6d9b-4dfa-b42c-8403fe1b281d"), Username = "gdiaz5" },
				new User { Id = new Guid("16c6e264-0091-45f6-b9fd-02716d8d62dd"), Username = "cwheeler6" },
				new User { Id = new Guid("0d1a6711-e9eb-418e-adda-47a62a7900c9"), Username = "bparker7" }
			};
