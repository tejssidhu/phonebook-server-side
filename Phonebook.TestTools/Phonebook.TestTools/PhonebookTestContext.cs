...
namespace Phonebook.TestTools
{
    public class PhonebookTestContext
    {
        ...
        public PhonebookTestContext()
        {
            ...
            SingleUser = new User { Id = new Guid("26e31dde-4bcb-47d4-be80-958676c5cafd"), Password = "789", Username = "User789" };
            ...
            SingleUser.PhoneBook = new List<Contact> { SingleContact, contact2, contact3 };
