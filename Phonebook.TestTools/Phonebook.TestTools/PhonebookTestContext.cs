...
namespace Phonebook.TestTools
{
	...
	public class PhonebookTestContext
    {
        ...
        public PhonebookTestContext()
        {
            ...
            SingleUser = new User { Id = new Guid("26e31dde-4bcb-47d4-be80-958676c5cafd"), Username = "User789" };
            ...
            SingleContact = new Contact { Id = new Guid("81c4763c-b225-4756-903a-750064167813"), UserId = new Guid("26e31dde-4bcb-47d4-be80-958676c5cafd"), Forename = "Theresa", Surname = "Reyes", Email = "treyes0@goo.gl", Title = "Dr" };
            ...
            ContactNumber = new ContactNumber { Id = new Guid("9a005b3e-d9ec-4e08-aefa-589ab5e00bfa"), ContactId = new Guid("81c4763c-b225-4756-903a-750064167813"), Description = "Mobile", TelephoneNumber = "391714697203" };
            ...
            SingleContact.ContactNumbers = new List<ContactNumber> { ContactNumber, contactNumber2 };
            ...
            SingleUser.Contacts = new List<Contact> { SingleContact, contact2, contact3 };
            user1.Contacts = new List<Contact> { contact4, contact5, contact6 };
            user2.Contacts = new List<Contact> { contact7, contact8, contact9, contact10 };
            user4.Contacts = new List<Contact> { contact11, contact12 };
            user5.Contacts = new List<Contact> { contact13, contact14, contact15, contact16, contact17, contact18, contact19 };
            user7.Contacts = new List<Contact> { contact20, contact21, contact22, contact23, contact24, contact25, contact26, contact27, contact28, contact29, contact30 };
            user8.Contacts = new List<Contact> { contact31, contact32 };
            user9.Contacts = new List<Contact> { contact33, contact34, contact35, contact36, contact37, contact38, contact39, contact40, contact41, contact42, contact43, contact44, contact45 };
            user10.Contacts = new List<Contact> { contact46, contact47, contact48, contact49, contact50, contact51, contact52 };
            user11.Contacts = new List<Contact> { contact53 };

            Users = new List<User> { user1, user2, SingleUser, user4, user5, user6, user7, user8, user9, user10, user11 };
            Contacts = new List<Contact> { SingleContact, contact2, contact3, contact4, contact5, contact6, contact7, contact8, contact9, contact10, contact11, contact12, contact13, contact14, contact15, contact16, contact17, contact18, contact19, contact20, contact21, contact22, contact23, contact24, contact25, contact26, contact27, contact28, contact29, contact31, contact32, contact33, contact34, contact35, contact36, contact37, contact38, contact39, contact40, contact41, contact42, contact43, contact44, contact45, contact46, contact47, contact48, contact49, contact50, contact51, contact52, contact53 };
            ContactNumbers = new List<ContactNumber> { ContactNumber, contactNumber2, contactNumber3, contactNumber4, contactNumber5, contactNumber6, contactNumber7, contactNumber8, contactNumber9, contactNumber10, contactNumber11, contactNumber12, contactNumber13, contactNumber14, contactNumber15, contactNumber16 };
        }
    }
}
